...
var libJSON = {};
$.getJSON('http://wiregate/scgi-edit/l', function(data) {
  libJSON = data;
  drawLibrary();
});
...
var logics = {};
$.getJSON('http://wiregate/scgi-edit/g?G1', function(data) {
  logics['logik'] = data;
  updateKnownLogics('logik');
});
$.getJSON('http://wiregate/scgi-edit/g?G2', function(data) {
  logics['logik2'] = data;
  updateKnownLogics('logik2');
});

// tweak backend communication, should also be done on demand
live = new CometVisu( 'http://wiregate/scgi/' );
liveUpdateCalls = [];
count = 10;
